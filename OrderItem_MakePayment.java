...
public class OrderItem_MakePayment {
	...
	public boolean launchDriver()
	{
		try {
			...
			if(os.contains("mac"))
			{
			  System.setProperty("webdriver.chrome.driver", "/Users/soumitdas/eclipse-workspace/automation/chromedriver");
			}
			else
			{
				System.setProperty("webdriver.chrome.driver", "/Users/soumitdas/eclipse-workspace/automation/chromedriver.exc");
			}
